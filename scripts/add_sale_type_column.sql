-- =============================================================================
-- Dahotre Arts — Add sale_type column (RETAIL | WHOLESALE) to orders
-- =============================================================================
...
-- 2. Backfill any existing rows that somehow have NULL
...
-- =============================================================================
-- 3. Update create_order_atomic RPC to accept sale_type
-- =============================================================================
